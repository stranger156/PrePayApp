...
=======
>>>>>>> abfd67f6bc57921561035201170ff9340394ef1c
...
>>>>>>> abfd67f6bc57921561035201170ff9340394ef1c
  ...
  const saveUser = (user) => {
    uni.setStorage({
      ...
      data: user,
      success: () => {
        formatAppLog("log", "at store/user.js:33", "user存储成功");
      },
      fail: (err) => {
        formatAppLog("error", "at store/user.js:36", "user存储失败:", err);
      }
    });
  };
  const getUser = () => {
    return new Promise((resolve, reject) => {
      uni.getStorage({
        ...
        fail: (err) => {
          formatAppLog("error", "at store/user.js:49", "user获取失败:", err);
          reject(err);
        }
      });
    });
...
=======
  const getStationList = async (page = 1, size = 5) => {
    try {
      const token = await getTokenFromLocalStorage();
      return request({
        url: "/web/stations/page",
      ...
      formatAppLog("error", "at utils/api.js:191", "获取token失败:", error);
      throw error;
    }
>>>>>>> abfd67f6bc57921561035201170ff9340394ef1c
  };
  const _imports_0$6 = "/static/username_icon.png";
  ...
  const _sfc_main$i = {
    ...
    setup(__props, { expose: __expose }) {
      ...
      const loginButton = () => {
        ...
        formatAppLog("log", "at pages/login/login.vue:97", 1111);
        formatAppLog("log", "at pages/login/login.vue:98", user);
        login(user).then((res) => {
          formatAppLog("log", "at pages/login/login.vue:100", res.data.token);
          if (res.code === 200) {
            saveTokenToLocalStorage(res.data.token);
            saveUser(user.username);
            formatAppLog("log", "at pages/login/login.vue:104", res.data.token);
            uni.switchTab({
              url: "/pages/map/map"
              // 假设这是一个 tabBar 页面
            });
      ...
      const __returned__ = { user, rememberPasswords, loginAuto, proxy, loginButton, callPhone, goToDetail, ref: vue.ref, onMounted: vue.onMounted, getCurrentInstance: vue.getCurrentInstance, reactive: vue.reactive, get login() {
        return login;
      ...
      vue.createElementVNode("view", { class: "input-container" }, [
        vue.createElementVNode("view", { class: "input-item" }, [
          vue.createElementVNode("img", {
            style: { "margin-left": "20rpx", "height": "5vh" },
            src: _imports_0$6
          }),
  ...
  const PagesLoginLogin = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["render", _sfc_render$h], ["__scopeId", "data-v-e4e4508d"], ["__file", "C:/Users/18171/Desktop/lvdeproject/PrePayApp/pages/login/login.vue"]]);
  const fontData = [
    {
  ...
  const UniIcons = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["render", _sfc_render$g], ["__scopeId", "data-v-946bce22"], ["__file", "C:/Users/18171/Desktop/lvdeproject/PrePayApp/node_modules/@dcloudio/uni-ui/lib/uni-icons/uni-icons.vue"]]);
  const _sfc_main$g = {
    __name: "map",
    setup(__props, { expose: __expose }) {
      __expose();
  ...
  const PagesMapMap = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["render", _sfc_render$f], ["__scopeId", "data-v-e06b858f"], ["__file", "C:/Users/18171/Desktop/lvdeproject/PrePayApp/pages/map/map.vue"]]);
  const _imports_0$5 = "/static/background.png";
  const _sfc_main$f = {
    __name: "PreLogin",
    setup(__props, { expose: __expose }) {
      __expose();
  ...
  const PagesPreLoginPreLogin = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["render", _sfc_render$e], ["__scopeId", "data-v-6f7f9871"], ["__file", "C:/Users/18171/Desktop/lvdeproject/PrePayApp/pages/PreLogin/PreLogin.vue"]]);
  ...
  const PagesIndexIndex = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["render", _sfc_render$d], ["__file", "C:/Users/18171/Desktop/lvdeproject/PrePayApp/pages/index/index.vue"]]);
  ...
  const PagesMoreMore = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["render", _sfc_render$c], ["__scopeId", "data-v-ac368486"], ["__file", "C:/Users/18171/Desktop/lvdeproject/PrePayApp/pages/more/more.vue"]]);
  ...
  const UniSearchBar = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["render", _sfc_render$b], ["__scopeId", "data-v-a149a6be"], ["__file", "C:/Users/18171/Desktop/lvdeproject/PrePayApp/node_modules/@dcloudio/uni-ui/lib/uni-search-bar/uni-search-bar.vue"]]);
  const _sfc_main$b = {
    data() {
      return {
        searchKey: "",
    ...
    methods: {
      async loadDeviceData() {
        ...
        try {
          ...
          if ((res == null ? void 0 : res.code) === 200 && res.data && Array.isArray(res.data.records)) {
            const data = res.data;
            this.pagination.total = data.total;
            const newData = this.processStationData(data.records);
            this.deviceList = [...this.deviceList, ...newData];
            this.pagination.finished = data.records.length === 0 || data.records.length < this.pagination.size;
      ...
      vue.createElementVNode(
        ...
        [
          ...
          vue.createElementVNode("view", { class: "loading-status" }, [
            $data.pagination.loading ? (vue.openBlock(), vue.createElementBlock("text", { key: 0 }, "加载中...")) : vue.createCommentVNode("v-if", true),
            $data.pagination.finished ? (vue.openBlock(), vue.createElementBlock("text", { key: 1 }, "没有更多数据了")) : vue.createCommentVNode("v-if", true)
          ])
        ],
        32
        /* NEED_HYDRATION */
  ...
  const PagesListList = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["render", _sfc_render$a], ["__scopeId", "data-v-98a9e0b2"], ["__file", "C:/Users/18171/Desktop/lvdeproject/PrePayApp/pages/list/list.vue"]]);
  ...
  const PagesSettingsSettings = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["render", _sfc_render$9], ["__file", "C:/Users/18171/Desktop/lvdeproject/PrePayApp/pages/settings/settings.vue"]]);
  class MPAnimation {
  ...
  const __easycom_0 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$8], ["__file", "C:/Users/18171/Desktop/lvdeproject/PrePayApp/node_modules/@dcloudio/uni-ui/lib/uni-transition/uni-transition.vue"]]);
  const _sfc_main$8 = {
    name: "uniPopup",
    components: {},
  ...
  const UniPopup = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render$7], ["__scopeId", "data-v-7db519c7"], ["__file", "C:/Users/18171/Desktop/lvdeproject/PrePayApp/node_modules/@dcloudio/uni-ui/lib/uni-popup/uni-popup.vue"]]);
  const _sfc_main$7 = {
    __name: "user",
    setup(__props, { expose: __expose }) {
      __expose();
      ...
      const __returned__ = { users, currentUser, searchKeyword, detailPopup, filteredUsers, handleSearch, showDetailModal, closeDetailModal, ref: vue.ref, computed: vue.computed, onMounted: vue.onMounted, UniSearchBar, UniIcons, UniPopup, get fetchCompanyList() {
  ...
  const PagesUserUser = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$6], ["__scopeId", "data-v-0f7520f0"], ["__file", "C:/Users/18171/Desktop/lvdeproject/PrePayApp/pages/user/user.vue"]]);
  ...
  const PagesErrorError = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$5], ["__file", "C:/Users/18171/Desktop/lvdeproject/PrePayApp/pages/error/error.vue"]]);
  const _sfc_main$5 = {
    __name: "account",
    setup(__props, { expose: __expose }) {
      __expose();
  ...
  const PagesAccountAccount = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$4], ["__scopeId", "data-v-8cce343a"], ["__file", "C:/Users/18171/Desktop/lvdeproject/PrePayApp/pages/account/account.vue"]]);
  ...
  const PagesRechargeRecordRechargeRecord = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$3], ["__file", "C:/Users/18171/Desktop/lvdeproject/PrePayApp/pages/recharge-record/recharge-record.vue"]]);
  const _sfc_main$3 = {
    __name: "setting",
    setup(__props, { expose: __expose }) {
      __expose();
  ...
  const PagesSettingSetting = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$2], ["__file", "C:/Users/18171/Desktop/lvdeproject/PrePayApp/pages/setting/setting.vue"]]);
  const _sfc_main$2 = {
  ...
  const PagesRemoteChargeRemoteCharge = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$1], ["__file", "C:/Users/18171/Desktop/lvdeproject/PrePayApp/pages/remote-charge/remote-charge.vue"]]);
  const _sfc_main$1 = {
...
<<<<<<< HEAD
  ...
  const __easycom_1 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$4], ["__scopeId", "data-v-3515f8e1"], ["__file", "C:/Users/86158/Documents/HBuilderProjects/PrePayApp/node_modules/@dcloudio/uni-ui/lib/uni-forms-item/uni-forms-item.vue"]]);
  var pattern = {
    email: /^\S+?@\S+?\.\S+?$/,
  ...
  const __easycom_2 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$3], ["__scopeId", "data-v-13523fe0"], ["__file", "C:/Users/86158/Documents/HBuilderProjects/PrePayApp/node_modules/@dcloudio/uni-ui/lib/uni-forms/uni-forms.vue"]]);
  const _sfc_main$3 = {
    __name: "add-station",
    setup(__props, { expose: __expose }) {
      __expose();
  ...
  const _sfc_main$1 = {
    ...
    setup(__props, { expose: __expose }) {
      ...
      const showDevicePopup = (item) => {
        ...
        formatAppLog("log", "at pages/company-stationList/company-stationList.vue:66", currentDevice);
      };
      ...
      const query = vue.ref(null);
      {
        getDevice().then((res) => {
          fetchStationList(res).then((res2) => {
            list.push(...res2.data);
            formatAppLog("log", "at pages/company-stationList/company-stationList.vue:82", res2.data);
          });
        });
      }
      const __returned__ = { list, currentDevice, showPopup, showDevicePopup, viewDeviceDetail, closePopup, query, getCurrentInstance: vue.getCurrentInstance, onMounted: vue.onMounted, reactive: vue.reactive, ref: vue.ref, get fetchStationList() {
        ...
        (vue.openBlock(true), vue.createElementBlock(
          ...
          vue.renderList($setup.list, (item, index) => {
            return vue.openBlock(), vue.createElementBlock("view", {
              class: "device-item",
              key: index,
              onClick: ($event) => $setup.showDevicePopup(item)
            }, [
        ...
        vue.createElementVNode("view", { class: "popup-body" }, [
          vue.createElementVNode("view", { class: "popup-item" }, [
            ...
            vue.createElementVNode(
              "text",
              { class: "popup-value" },
              vue.toDisplayString($setup.currentDevice.stationName),
              1
              /* TEXT */
            )
          ]),
          vue.createElementVNode("view", { class: "popup-item" }, [
            ...
            vue.createElementVNode(
              "text",
              { class: "popup-value" },
              vue.toDisplayString($setup.currentDevice.address),
              1
              /* TEXT */
            )
          ]),
          vue.createElementVNode("view", { class: "popup-item" }, [
            vue.createElementVNode("text", { class: "popup-label" }, "所属公司:"),
            vue.createElementVNode(
              "text",
              { class: "popup-value" },
              vue.toDisplayString($setup.currentDevice.company),
              1
              /* TEXT */
            )
          ]),
          vue.createElementVNode("view", { class: "popup-item" }, [
            vue.createElementVNode("text", { class: "popup-label" }, "负责人:"),
            vue.createElementVNode(
              "text",
              { class: "popup-value" },
              vue.toDisplayString($setup.currentDevice.userName),
              1
              /* TEXT */
            )
          ]),
          vue.createElementVNode("view", { class: "popup-item" }, [
            vue.createElementVNode("text", { class: "popup-label" }, "联系方式:"),
            vue.createElementVNode(
              "text",
              { class: "popup-value" },
              vue.toDisplayString($setup.currentDevice.phone),
              1
              /* TEXT */
            )
          ]),
          vue.createElementVNode("view", { class: "popup-buttons" }, [
            ...
            vue.createElementVNode("button", {
              ...
              onClick: _cache[0] || (_cache[0] = (...args) => _ctx.controlDevice && _ctx.controlDevice(...args))
            }, "查看实时数据")
          ])
        ])
      ])) : vue.createCommentVNode("v-if", true)
...
=======
  const PagesChangePasswordChangePassword = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__file", "C:/Users/18171/Desktop/lvdeproject/PrePayApp/pages/change-password/change-password.vue"]]);
>>>>>>> abfd67f6bc57921561035201170ff9340394ef1c
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "C:/Users/18171/Desktop/lvdeproject/PrePayApp/App.vue"]]);
  function createApp() {
