...
(function(vue) {
  ...
  const charge = async (params) => {
    formatAppLog("log", "at utils/api.js:279", params);
    const token = await getTokenFromLocalStorage();
    return request({
    ...
    methods: {
      ...
      async loadCompanyList() {
        try {
          ...
          formatAppLog("error", "at pages/list/list.vue:989", "加载公司列表失败:", error);
        }
      },
      //搜索功能实现
      handleCancel() {
      ...
      async saveDeviceInfo() {
        try {
          ...
          if (res.code === 200) {
            formatAppLog("log", "at pages/list/list.vue:1131", "hello");
            uni.showToast({
              title: "保存成功",
              icon: "success",
              duration: 1e3,
          ...
          formatAppLog("error", "at pages/list/list.vue:1159", "保存设备信息失败:", error);
          uni.showToast({
            title: "网络异常，请稍后重试",
            icon: "none"
          });
      ...
      handleDateChange(value) {
        ...
        formatAppLog("log", "at pages/list/list.vue:1172", "选择的日期:", value);
      },
      initTempChart() {
        var _a, _b;
      ...
      async confirmDelete() {
        ...
        try {
          ...
          formatAppLog("error", "at pages/list/list.vue:1291", "删除设备失败:", error);
          uni.showToast({
            title: "删除设备失败，请稍后重试",
            icon: "none"
          });
      ...
      async handleRecharge(e2) {
        try {
          ...
          formatAppLog("error", "at pages/list/list.vue:1358", "设备充值失败:", error);
          uni.showToast({
            title: "设备充值异常，请稍后重试",
            icon: "none"
          });
      ...
      async loadDeviceData() {
        ...
        try {
          ...
          if ((res == null ? void 0 : res.code) === 200 && res.data) {
            formatAppLog("log", "at pages/list/list.vue:1401", res);
            const data = res.data;
      ...
      async showStationDetail(station) {
        formatAppLog("log", "at pages/list/list.vue:1456", station);
        ...
        try {
          ...
          formatAppLog("error", "at pages/list/list.vue:1467", "加载设备失败:", error);
      ...
      async generateDeviceList(station) {
        try {
          ...
          if ((res == null ? void 0 : res.code) === 200 && res.data) {
            formatAppLog("log", "at pages/list/list.vue:1486", res);
          ...
          formatAppLog("error", "at pages/list/list.vue:1498", "获取设备失败:", error);
          return [{
            name: "数据加载失败",
            code: "ERROR",
            status: "异常"
      ...
      async submitCharge() {
        try {
          ...
          formatAppLog("log", "at pages/list/list.vue:1535", "充值响应:", res);
          if ((res == null ? void 0 : res.code) === 200) {
          ...
          formatAppLog("error", "at pages/list/list.vue:1545", "充值流程错误:", error);
          uni.showToast({
      ...
      async showInstallInfo(device) {
        ...
        try {
          formatAppLog("log", "at pages/list/list.vue:1557", device);
          ...
          formatAppLog("error", "at pages/list/list.vue:1588", "加载设备安装信息失败:", error);
          uni.showToast({
            title: "设备安装信息加载失败",
            icon: "none"
          });
      ...
      async showDeviceDetail(device) {
        ...
        try {
          formatAppLog("log", "at pages/list/list.vue:1612", device);
          const res = await getDetailDevices(device.code);
          formatAppLog("log", "at pages/list/list.vue:1614", res.data);
          formatAppLog("log", "at pages/list/list.vue:1615", res.data.tempDiffHistory.length);
          let xarr = [];
          let yarr = [];
          ...
          formatAppLog("log", "at pages/list/list.vue:1628", this.chartData.series[0].data);
          if ((res == null ? void 0 : res.code) === 200 && res.data) {
          ...
          formatAppLog("error", "at pages/list/list.vue:1657", "加载设备失败:", error);
          uni.showToast({
            title: "加载设备数据失败",
            icon: "none"
          });
