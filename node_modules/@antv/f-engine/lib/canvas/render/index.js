...
exports.getUpdateAnimation = getUpdateAnimation;
...
function createVNode(parent, vNode) {
  ...
  var animator = new _animator.default();
  ...
  if (tag === _workTags.Shape) {
    ...
    if (tag === _workTags.ClassComponent) {
      ...
      component = new _component.default(props, componentContext, updater);
...
function getUpdateAnimation(component, newChildren, keyFrame) {
  var preNode = component.preNode;
  var lastChildren = preNode.children,
    props = preNode.props;
  // 是否需要更新
  if (component.shouldUpdate(props) === false) {
    return false;
  ...
  component.willUpdate();
  var nextChildren = renderChildren(preNode, newChildren, lastChildren);
  // 更新 children
  component.preNode.children = nextChildren;
  // 创建动画
  var childrenAnimation = (0, _animation.createAnimation)(preNode, nextChildren, lastChildren);
  component.didUpdate();
  // 处理 animator
  var animUnits = (0, _animation.calAnimationTime)(childrenAnimation, keyFrame);
  return animUnits;
}