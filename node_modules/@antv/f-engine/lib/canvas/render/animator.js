...
var Animator = /** @class */function (_super) {
  (0, _tslib.__extends)(Animator, _super);
  function Animator() {
  ...
  Animator.prototype.run = function () {
    ...
    if (effect) {
      ...
      if ((property.length || onFrame_1) && duration > 0) {
        // 应用样式
        var style = (0, _tslib.__assign)((0, _tslib.__assign)({}, (0, _util.omit)(start, property)), (0, _util.omit)(end, property));
        ...
        // 结束帧
        var keyframeEnd = (0, _util.pick)(end, property);
        ...
        if (animation) {
          var onframe_1 = onFrame_1 ? function (e) {
            ...
            (0, _applyStyle.default)(shape, onFrame_1(t, context));
          } : null;
          ...
          // 如果没有执行动画，直接应用结束样式
          (0, _applyStyle.default)(shape, end);
        }
      } else {
        // 直接应用结束样式
        (0, _applyStyle.default)(shape, end);
      ...
      // clip 动画
      if (clip) {
        var clipConfig = (0, _util.isFunction)(clip) ? clip(end) : clip;
        if (clipConfig) {
          ...
          if (clipProperty.length && (clipDuration || duration) > 0) {
            var clipStartStyle_1 = (0, _tslib.__assign)((0, _tslib.__assign)({}, clipStyle), clipStart);
            var clipEndStyle = (0, _tslib.__assign)((0, _tslib.__assign)({}, clipStyle), clipEnd);
            // 开始帧
            ...
            // 结束帧
            var clipKeyframeEnd = (0, _util.pick)(clipEndStyle, clipProperty);
            var clipShape_1 = (0, _createShape.createShape)(clipType, {
