...
import { DeviceRendererPluginOptions, RendererParameters } from './interfaces';
...
export declare class Plugin extends AbstractRendererPlugin {
    ...
    constructor(options?: Partial<DeviceRendererPluginOptions>);
    init(runtime: GlobalRuntime): void;
    destroy(runtime: GlobalRuntime): void;
    private getRenderGraphPlugin;
    getDevice(): import("@antv/g-device-api").Device;
