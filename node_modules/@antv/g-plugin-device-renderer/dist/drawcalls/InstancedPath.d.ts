 ...
 */
export declare class InstancedPathDrawcall extends Instanced {
    protected renderHelper: RenderHelper;
    protected texturePool: TexturePool;
    protected lightPool: LightPool;
    static calcSubpathNum(object: DisplayObject): number;
    ...
    protected mergeAnchorIntoModelMatrix: boolean;
    private segmentNum;
    private calcSegmentNum;
    private calcSubpathIndex;
    /**
...
export declare function updateBuffer(object: DisplayObject, needEarcut?: boolean, segmentNum?: number, subPathIndex?: number): {
    pointsBuffer: number[];
    travelBuffer: number[];
    triangles: number[];
