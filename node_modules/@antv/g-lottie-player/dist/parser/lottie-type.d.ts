...
export declare enum Layer3DMode {
    Off = 0,
    On = 1
}
export declare enum AutoOrientMode {
    Off = 0,
    On = 1
}
...
export declare const enum MaskMode {
    No = "n",
    Add = "a",
    Subtract = "s",
    Intersect = "i",
...
export declare enum VerticalJustify {
    Top = 0,
    Center = 1,
    Bottom = 2
}
...
export declare const enum RangeSelectorDomain {
    Characters = 1,
    CharactersExcludingSpaces = 2,
    Words = 3,
    Lines = 4
}
export declare const enum RangeSelectorShape {
    Square = 1,
    RampUp = 2,
    RampDown = 3,
    Triangle = 4,
...
export declare const enum RangeSelectorUnits {
    Percentage = 1,
    Index = 2
}
export declare const enum RangeSelectorMode {
    Add = 1,
    Subtract = 2,
    Intersect = 3,
    Min = 4,
...
export declare enum FontPathOrigin {
    CssUrl = 1,
    ScriptUrl = 2,
    FontUrl = 3
}
