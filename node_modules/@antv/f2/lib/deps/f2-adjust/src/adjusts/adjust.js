...
var Adjust = /** @class */function () {
  ...
  Adjust.prototype.setIndexMap = function (_a) {
    var key = _a.key,
      index = _a.index;
  ...
  /** @override */
  Adjust.prototype.adjustDim = function (_dim, _values, _data, _index) {};
  /**
   * 获取可调整度量对应的值
   * @param mergedData 数据
   * @return 值的映射
  ...
  Adjust.prototype.getDimValues = function (mergedData) {
    ...
    dims.forEach(function (dim) {
      ...
      // 在每个维度上，所有的值
      dimValuesMap[dim] = (0, _util.valuesOfKey)(mergedData, dim).sort(function (v1, v2) {
        return v1 - v2;
      }).filter(function (v) {
        return !isNaN(v);
      });
