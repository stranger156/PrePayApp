...
export interface CandlestickProps<TRecord extends DataRecord = DataRecord> extends GeometryProps<TRecord> {
    /**
     * 柱子的显示比例，默认 0.5
     */
    sizeRatio?: number;
...
declare const _default: (View: ComponentType) => {
    new <TRecord extends DataRecord = DataRecord, IProps extends CandlestickProps<TRecord> = CandlestickProps<TRecord>>(props: IProps & import("../../chart").ChartChildProps<DataRecord>, context?: any): {
        getDefaultCfg(): {
            geomType: string;
        };
        getSize(): number;
