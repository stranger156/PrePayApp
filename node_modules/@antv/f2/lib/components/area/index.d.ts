import withArea, { AreaProps } from './withArea';
import AreaView from './areaView';
export { AreaProps, withArea, AreaView };
declare const _default: {
    new <TRecord extends import("../../chart/Data").DataRecord = import("../../chart/Data").DataRecord, IProps extends AreaProps<TRecord> = AreaProps<TRecord>>(props: IProps & import("../../chart").ChartChildProps<import("../../chart/Data").DataRecord>, context?: any): {
        getDefaultCfg(): {
            geomType: string;
            startOnZero: boolean;
            sortable: boolean;
