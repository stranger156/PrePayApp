import withPoint, { PointProps } from './withPoint';
import PointView from './pointView';
export { PointProps, PointView, withPoint };
declare const _default: {
    new <TRecord extends import("../../chart/Data").DataRecord = import("../../chart/Data").DataRecord, IProps extends PointProps<TRecord> = PointProps<TRecord>>(props: IProps & import("../../chart").ChartChildProps<import("../../chart/Data").DataRecord>, context?: any): {
        getDefaultCfg(): {
            geomType: string;
        };
