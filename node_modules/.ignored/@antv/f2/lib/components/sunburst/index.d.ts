import withSunburst, { SunburstProps } from './withSunburst';
import SunburstView from './sunburstView';
import IcicleView from './icicleView';
export { SunburstProps, withSunburst, SunburstView, IcicleView };
declare const _default: {
    new <TRecord extends import("../../chart/Data").DataRecord = import("../../chart/Data").DataRecord, IProps extends SunburstProps<TRecord> = SunburstProps<TRecord>>(props: IProps, context: any): {
