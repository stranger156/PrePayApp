...
export interface PictorialProps<TRecord extends DataRecord = DataRecord> extends GeometryProps<TRecord> {
    symbol?: any;
}
declare const Pictorial_base: {
    new <TRecord extends DataRecord = DataRecord, IProps extends import("../interval").IntervalProps<TRecord> = import("../interval").IntervalProps<TRecord>>(props: IProps & import("../../chart").ChartChildProps<DataRecord>, context?: any): {
        getDefaultCfg(): {
            geomType: string;
...
export default class Pictorial extends Pictorial_base {
